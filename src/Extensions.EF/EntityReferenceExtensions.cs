...
namespace JosephGuadagno.Extensions.EF
{
    ...
    ///     class requires meta data for a key but does not directly expose that metaDomain. This class exposes the
    ///     keys as pure values.
    /// </summary>
    /// <example>
    ///     <code>
    ...
    public static class EntityReferenceExtensions
    {
        ...
        ///     Index of the key component (with respect to the element type's
        ...
        /// <summary>
        ///     Uses internal API to access meta data for related end target.
        /// </summary>
